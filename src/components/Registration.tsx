...
const Registration = () => (
  ...
  >
    <Card className="shadow-sm rounded-4 p-4 border-0" style={{ maxWidth: '900px', width: '100%' }}>
      <div className="text-center mb-4">
        <img
          ...
          style={{ width: 120 }}
        />
        <h3 className="fw-bold" style={{ color: '#2A6ED9', fontSize: '1.4rem' }}>
          Register
        </h3>
      ...
      <Formik
        ...
        onSubmit={async (values, { setSubmitting, resetForm }) => {
          try {
            const response = await AuthService.register(values); // 🔥 API integration
            if (response?.status) {
        ...
        {({ handleSubmit, handleChange, handleBlur, values, touched, errors, isSubmitting }) => (
          <Form noValidate onSubmit={handleSubmit}>
            ...
            <Button
              ...
              style={{ backgroundColor: '#2A6ED9', border: 'none', fontWeight: '600' }}
            >
              Register
            </Button>
          </Form>
