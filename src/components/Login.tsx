...
const LoginSchema = Yup.object().shape({
  userName: Yup.string().email("Invalid UserName").required("User name is required"),
  password: Yup.string().min(6, "Too short! Minimum 6 characters.").required("Password is required"),
});
    ...
    <Container fluid className="p-0 min-vh-100">
      <Row className="g-0 min-vh-100">
        <Col
          ...
          style={{ background: "linear-gradient(135deg, #1576f2 0%, #57c6fd 100%)" }}
        >
          <img
            src={logicShip}
            alt="Cruise Ship"
        ...
        <Col xs={12} md={6} className="d-flex align-items-center justify-content-center bg-white">
          <Card className="border-0 shadow-lg w-100 mx-3" style={{ maxWidth: 420, borderRadius: "18px" }}>
